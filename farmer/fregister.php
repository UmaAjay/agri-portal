 ...
 <footer class="footer">
        <div class="container">
                ...
                <div class="offset-sm-2 col-5 ">
                    <h5>Our Address</h5>
                    <address>
                    # 636, BDA Block 2, APMC (RMC) Yard Vegetables<br>
                    Market, Yeswanthpur, Bengaluru, Karnataka 560022<br>		              
		              <div class="btn-group text-center" role="group">
                    <a role="button" class="btn btn-primary" href="tel:+9148041589"><i class="fa fa-phone"></i> Call</a>
                    <a role="button" class="btn btn-info" href="tel:+9191480415859"> <i class="fa fa-fax"></i> Fax</a>
                    <a role="button" class="btn btn-success" href="mailto:umaveena.alvas@gmail.com"> <i class="fa fa-envelope-o"></i> Email</a>
                </div>
		           </address>
                </div>				
       ...
       <button target="_blank" href="/" rel="nofollow" class="btn btn-icon-only btn-linkedin rounded-circle" data-toggle="tooltip" data-original-title="Mail Us">
          ...
          <button target="_blank" href="/" rel="nofollow" class="btn btn-icon-only btn-github rounded-circle" data-toggle="tooltip" data-original-title="Star on Github">
           ...
           <div class="row justify-content-center">             
                     <div class="col-auto">					
                    <p>&copy; Copyright 2023 WAY2AGRIBUSINESS, All Rights Reserved </p>
                </div>
           </div>
        </div>
    </footer>
