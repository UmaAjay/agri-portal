 <footer class="footer">
        <div class="container">
                ...
                <div class="offset-sm-2 col-5 ">
                    ...
                    <a role="button" class="btn btn-primary" href="tel:+919148041589"><i class="fa fa-phone"></i> Call</a>
                    <a role="button" class="btn btn-info" href="tel:+919148041589"> <i class="fa fa-fax"></i> Fax</a>
